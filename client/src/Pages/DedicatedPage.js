    ...
    return <main>
        ...
        <section className="why-dedecated-serive-sec">
            <div style={{ textAlign: "center", color: "#fff", marginBottom: "50px" }}>
                ...
                <p>Embrace not just the tech-talent and knowledge but also avail a unique perspective on your complicated projects with innovative approach, accessible resources at an affordable cost. TatvaSoft empowers businesses with dedicated software development teams and services.</p>
            </div>
            <Container>
                <Row>
                    <Col lg={6}>
                        <SimpleTile imgURL="/static/icons/faster_resource_accessibility.svg"
                            ...
                            text="Solve your business challenges by teaming up with TatvaSoft for accessible and skilled software developers, architects, team leads and project managers. We use the latest, secure and interactive technologies for day to day resource reporting and status analysis." />
                    </Col>
                    <Col lg={6}>
                    ...
                    <Col lg={6}>
                        <SimpleTile imgURL="/static/icons/cost_effective_and_flexible_solutions.svg"
                            ...
                            text="Adaptive to changing market needs, TatvaSoft's dedicated development teams of software engineers are open to new learnings. Businesses can ramp up and down resources to adhere to real-time market disruptions and maintain the quality of product with lower cost of investment and higher returns at the same time." />
                    </Col>
                    <Col lg={6}>
                        <SimpleTile imgURL="/static/icons/larger_technology_pool.svg"
                            title="Larger Technology pool"
                            text="TatvaSoft adapts rigorous hiring and training systems to ensure we have competent and best in class resources. Our dedicated software developers are versatile and proficient with modern technologies, tools and methods to quickly meet clients' unique business needs." />
                    </Col>
                </Row>
            </Container>
        </section>
